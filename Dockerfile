...
#   - Ex: hexpm/elixir:1.18.1-erlang-27.1.3-debian-bullseye-20250113-slim
#
...
# install npm packages and change back to build dir
WORKDIR /app/assets
RUN npm install
WORKDIR /app
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/monolith ./
